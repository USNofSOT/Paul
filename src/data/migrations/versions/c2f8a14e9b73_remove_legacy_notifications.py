"""Remove legacy notification storage and activity caches.

Revision ID: c2f8a14e9b73
Revises: 714174f5cb32
...
revision: str = "c2f8a14e9b73"
down_revision: str | None = "714174f5cb32"
...
def downgrade() -> None:
    ...
    if "notification_events" not in inspector.get_table_names():
        op.create_table(
            ...
            sa.Column("threshold_at", sa.DateTime(), nullable=False),
        ...
        op.create_index(
            "ix_notification_events_status_scheduled_for_at",
            "notification_events",
