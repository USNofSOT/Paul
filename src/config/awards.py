...
from src.data.structs import AwardsCollector
...
RECRUITMENT_RIBBON = awards_repository.find_by_name("Recruitment Ribbon")
...
###############################################################################
NCO_IMPROVEMENT_RIBBON = awards_repository.find_by_name("NCO Improvement Ribbon")
