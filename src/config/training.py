...
ALL_TRAINING_RECORDS_CHANNELS: Final[tuple[int, int, int, int, int, int]] = NRC_RECORDS_CHANNEL, JLA_RECORDS_CHANNEL, SNLA_RECORDS_CHANNEL, OCS_RECORDS_CHANNEL, SOCS_RECORDS_CHANNEL, ST_RECORDS_CHANNEL
