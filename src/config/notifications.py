...
from src.config.ships import (
    ...
    ROLE_ID_NIGHTINGALE,
    ROLE_ID_TITAN,
    ROLE_ID_VENOM, ROLE_ID_SERENITY, ROLE_ID_ADUN, ROLE_ID_HYPERION, ROLE_ID_BERSERKER, ROLE_ID_LUSTY, ROLE_ID_PHANTOM,
)
...
NOTIFICATION_DELIVERY_STAGGER_SECONDS: Final[float] = 1.5
